...
function openFreebieForm(id){
  ...
  if(id){
    ...
    document.getElementById('freebieMeetingId').value = f.meeting_id || '';
    document.getElementById('freebiePasscode').value = f.passcode || '';
    ...
    ['freebieId','freebieTitle','freebieDesc','freebieLink','freebieScheduledAt','freebieMeetingId','freebiePasscode'].forEach(fid=> document.getElementById(fid).value = '');
  }
...
function updateFreebieFormFields(){
  ...
  document.getElementById('freebieMeetingIdGroup').style.display = isWebinar ? 'flex' : 'none';
  document.getElementById('freebiePasscodeGroup').style.display = isWebinar ? 'flex' : 'none';
...
document.getElementById('btnSaveFreebie').addEventListener('click', async ()=>{
  ...
  const payload = {
    ...
    meeting_id: type==='webinar' ? (document.getElementById('freebieMeetingId').value.trim() || null) : null,
    passcode: type==='webinar' ? (document.getElementById('freebiePasscode').value.trim() || null) : null,
